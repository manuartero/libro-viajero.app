...
**Mobile-first, always.** The teacher is standing in a classroom with a phone in one hand and a backpack in the other. Everything must be tappable; nothing should require precision — in portrait, without glasses.

**Speed over completeness.** A Friday check-in should take under 2 minutes. Any feature that adds time to the Friday flow is the wrong feature.

**No real names.** Children's names are sensitive. The teacher knows who "🐸 Verde" is; no one else does. Privacy by design, not by policy.
...
**Zero infrastructure.** No server, no database, no subscription, no login — because there is nothing to log in to. If the app disappeared tomorrow, there's nothing to lose and nothing to protect.
