...
import stepStyles from "./step-screen.module.css";
...
export function AssignStep({
  ...
  return (
    <StepScreen
      ...
      dateline={`Paso 4 de 4 · Curso ${yearShort} · ${assignedCount} de ${childList.length} con libro`}
      backLabel="Volver a los libros"
      onBack={onBack}
      footer={
        <button
          type="button"
          className={stepStyles.create}
